...
pub use tdoa_observation::PyTDOAObservation;
pub use fdoa_observation::PyFDOAObservation;
...
pub fn register_estimation(parent_module: &Bound<'_, PyModule>) -> PyResult<()> {
    ...
    estimation.add_class::<PyTDOAObservation>()?;
    estimation.add_class::<PyFDOAObservation>()?;
