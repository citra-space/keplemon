...
pub struct SAALObservation {
    pub security_character: String,
    pub satellite_number: i32,
    pub sensor_number: i32,
    pub epoch_ds50utc: f64,
    pub elevation_or_declination: f64,
    pub azimuth_or_right_ascension: f64,
    pub slant_range: f64,
    pub range_rate: f64,
    pub elevation_rate: f64,
    pub azimuth_rate: f64,
    pub range_acceleration: f64,
    pub observation_type: String,
    pub track_position_indicator: i32,
...
impl SAALObservation {
    pub fn new(b3_string: &str) -> Result<Self, String> {
        ...
        match result {
            0 => Ok(SAALObservation {
                security_character: sec_char.value(),
                satellite_number: sat_num,
                sensor_number: sen_num,
                epoch_ds50utc: obs_time_ds50utc,
                elevation_or_declination: el_or_dec,
                azimuth_or_right_ascension: az_or_ra,
                slant_range,
                range_rate,
                elevation_rate: el_rate,
                azimuth_rate: az_rate,
                range_acceleration: range_accel,
                observation_type: obs_type.value(),
                track_position_indicator: track_ind,
...
impl SAALObservation {
    #[classattr]
    pub const XA_OBS_SECCLASS: usize = XA_OBS_SECCLASS;

    #[classattr]
    pub const XA_OBS_SATNUM: usize = XA_OBS_SATNUM;

    #[classattr]
    pub const XA_OBS_SENNUM: usize = XA_OBS_SENNUM;

    #[classattr]
    pub const XA_OBS_DS50UTC: usize = XA_OBS_DS50UTC;

    #[classattr]
    pub const XA_OBS_OBSTYPE: usize = XA_OBS_OBSTYPE;

    #[classattr]
    pub const XA_OBS_ELORDEC: usize = XA_OBS_ELORDEC;

    #[classattr]
    pub const XA_OBS_AZORRA: usize = XA_OBS_AZORRA;

    #[classattr]
    pub const XA_OBS_RANGE: usize = XA_OBS_RANGE;

    #[classattr]
    pub const XA_OBS_RANGERATE: usize = XA_OBS_RANGERATE;

    #[classattr]
    pub const XA_OBS_ELRATE: usize = XA_OBS_ELRATE;

    #[classattr]
    pub const XA_OBS_AZRATE: usize = XA_OBS_AZRATE;

    #[classattr]
    pub const XA_OBS_RANGEACCEL: usize = XA_OBS_RANGEACCEL;

    #[classattr]
    pub const XA_OBS_TRACKIND: usize = XA_OBS_TRACKIND;

    #[classattr]
    pub const XA_OBS_ASTAT: usize = XA_OBS_ASTAT;

    #[classattr]
    pub const XA_OBS_SITETAG: usize = XA_OBS_SITETAG;

    #[classattr]
    pub const XA_OBS_SPADOCTAG: usize = XA_OBS_SPADOCTAG;

    #[classattr]
    pub const XA_OBS_POSX: usize = XA_OBS_POSX;

    #[classattr]
    pub const XA_OBS_POSY: usize = XA_OBS_POSY;

    #[classattr]
    pub const XA_OBS_POSZ: usize = XA_OBS_POSZ;

    #[classattr]
    pub const XA_OBS_VELX: usize = XA_OBS_VELX;

    #[classattr]
    pub const XA_OBS_VELY: usize = XA_OBS_VELY;

    #[classattr]
    pub const XA_OBS_VELZ: usize = XA_OBS_VELZ;

    #[classattr]
    pub const XA_OBS_YROFEQNX: usize = XA_OBS_YROFEQNX;

    #[classattr]
    pub const XA_OBS_ABERRATION: usize = XA_OBS_ABERRATION;

    #[classattr]
    pub const XA_OBS_AZORRABIAS: usize = XA_OBS_AZORRABIAS;

    #[classattr]
    pub const XA_OBS_ELORDECBIAS: usize = XA_OBS_ELORDECBIAS;

    #[classattr]
    pub const XA_OBS_RGBIAS: usize = XA_OBS_RGBIAS;

    #[classattr]
    pub const XA_OBS_RRBIAS: usize = XA_OBS_RRBIAS;

    #[classattr]
    pub const XA_OBS_TIMEBIAS: usize = XA_OBS_TIMEBIAS;

    #[classattr]
    pub const XA_OBS_RAZORRABIAS: usize = XA_OBS_RAZORRABIAS;

    #[classattr]
    pub const XA_OBS_RELORDECBIAS: usize = XA_OBS_RELORDECBIAS;

    #[classattr]
    pub const XA_OBS_SIGMATYPE: usize = XA_OBS_SIGMATYPE;

    #[classattr]
    pub const XA_OBS_SIGMAEL1: usize = XA_OBS_SIGMAEL1;

    #[classattr]
    pub const XA_OBS_SIGMAEL2: usize = XA_OBS_SIGMAEL2;

    #[classattr]
    pub const XA_OBS_SIGMAEL3: usize = XA_OBS_SIGMAEL3;

    #[classattr]
    pub const XA_OBS_SIGMAEL4: usize = XA_OBS_SIGMAEL4;

    #[classattr]
    pub const XA_OBS_SIGMAEL5: usize = XA_OBS_SIGMAEL5;

    #[classattr]
    pub const XA_OBS_SIGMAEL6: usize = XA_OBS_SIGMAEL6;

    #[classattr]
    pub const XA_OBS_SIGMAEL7: usize = XA_OBS_SIGMAEL7;

    #[classattr]
    pub const XA_OBS_SIGMAEL8: usize = XA_OBS_SIGMAEL8;

    #[classattr]
    pub const XA_OBS_SIGMAEL9: usize = XA_OBS_SIGMAEL9;

    #[classattr]
    pub const XA_OBS_SIGMAEL10: usize = XA_OBS_SIGMAEL10;

    #[classattr]
    pub const XA_OBS_SIGMAEL11: usize = XA_OBS_SIGMAEL11;

    #[classattr]
    pub const XA_OBS_SIGMAEL12: usize = XA_OBS_SIGMAEL12;

    #[classattr]
    pub const XA_OBS_SIGMAEL13: usize = XA_OBS_SIGMAEL13;

    #[classattr]
    pub const XA_OBS_SIGMAEL14: usize = XA_OBS_SIGMAEL14;

    #[classattr]
    pub const XA_OBS_SIGMAEL15: usize = XA_OBS_SIGMAEL15;

    #[classattr]
    pub const XA_OBS_SIGMAEL16: usize = XA_OBS_SIGMAEL16;

    #[classattr]
    pub const XA_OBS_SIGMAEL17: usize = XA_OBS_SIGMAEL17;

    #[classattr]
    pub const XA_OBS_SIGMAEL18: usize = XA_OBS_SIGMAEL18;

    #[classattr]
    pub const XA_OBS_SIGMAEL19: usize = XA_OBS_SIGMAEL19;

    #[classattr]
    pub const XA_OBS_SIGMAEL20: usize = XA_OBS_SIGMAEL20;

    #[classattr]
    pub const XA_OBS_SIGMAEL21: usize = XA_OBS_SIGMAEL21;

    #[classattr]
    pub const XA_OBS_SIZE: usize = XA_OBS_SIZE;

    #[new]
    pub fn py_new(b3_string: &str) -> PyResult<Self> {
        SAALObservation::new(b3_string).map_err(PyErr::new::<pyo3::exceptions::PyRuntimeError, _>)
    }

    #[getter]
    pub fn security_character(&self) -> &str {
        &self.security_character
    }

    #[getter]
    pub fn satellite_number(&self) -> i32 {
    ...
    #[getter]
    pub fn epoch_ds50utc(&self) -> f64 {
        self.epoch_ds50utc
    }
    #[getter]
    pub fn elevation_or_declination(&self) -> f64 {
        self.elevation_or_declination
    }
    #[getter]
    pub fn azimuth_or_right_ascension(&self) -> f64 {
        self.azimuth_or_right_ascension
    }
    #[getter]
    ...
    #[getter]
    pub fn track_position_indicator(&self) -> i32 {
        self.track_position_indicator
    }
    #[getter]
    pub fn association_status(&self) -> i32 {
        self.association_status
    }
    #[getter]
    pub fn site_tag(&self) -> i32 {
        self.site_tag
    }
    #[getter]
    pub fn spadoc_tag(&self) -> i32 {
        self.spadoc_tag
    }
    #[getter]
...
impl ObsInterface {
    pub fn get_csv_from_b3(b3_string: &str) -> Result<String, String> {
        let mut input_str = GetSetString::from_string(b3_string);
    ...
    pub fn get_field(ob_key: i64, field_index: i32) -> Result<f64, String> {
    ...
    pub fn get_array(ob_key: i64) -> Result<[f64; XA_OBS_SIZE], String> {
        let mut output_array = [0.0; XA_OBS_SIZE];
...
impl ObsInterface {
    #[staticmethod]
    #[pyo3(name = "get_csv_from_b3")]
    pub fn py_get_csv_from_b3(b3_string: &str) -> PyResult<String> {
        ObsInterface::get_csv_from_b3(b3_string).map_err(PyErr::new::<pyo3::exceptions::PyRuntimeError, _>)
    }

    #[staticmethod]
    #[pyo3(name = "load_from_b3")]
    pub fn py_load_from_b3(b3_string: &str) -> PyResult<i64> {
        ObsInterface::load_from_b3(b3_string).map_err(PyErr::new::<pyo3::exceptions::PyRuntimeError, _>)
    }

    #[staticmethod]
    pub fn remove_key(obs_key: i64) {
        unsafe { ObsRemove(obs_key) };
    }

    #[staticmethod]
    #[pyo3(name = "get_field")]
    pub fn py_get_field(ob_key: i64, field_index: i32) -> PyResult<f64> {
        ObsInterface::get_field(ob_key, field_index).map_err(PyErr::new::<pyo3::exceptions::PyRuntimeError, _>)
    }

    #[staticmethod]
    #[pyo3(name = "get_array")]
    pub fn py_get_array(ob_key: i64) -> PyResult<[f64; XA_OBS_SIZE]> {
        ObsInterface::get_array(ob_key).map_err(PyErr::new::<pyo3::exceptions::PyRuntimeError, _>)
    }
