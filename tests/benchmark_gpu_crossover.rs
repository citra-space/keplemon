...
const SCENARIOS: &[PropagationScenario] = &[
    PropagationScenario { dt_minutes: 1.0, n_periods: 1, description: "1-min dt, 1 period" },
    PropagationScenario { dt_minutes: 1.0, n_periods: 5, description: "1-min dt, 5 periods" },
    PropagationScenario { dt_minutes: 1.0, n_periods: 10, description: "1-min dt, 10 periods" },
    PropagationScenario { dt_minutes: 1.0, n_periods: 20, description: "1-min dt, 20 periods" },
    
    PropagationScenario { dt_minutes: 10.0, n_periods: 1, description: "10-min dt, 1 period" },
    PropagationScenario { dt_minutes: 10.0, n_periods: 5, description: "10-min dt, 5 periods" },
    PropagationScenario { dt_minutes: 10.0, n_periods: 10, description: "10-min dt, 10 periods" },
    PropagationScenario { dt_minutes: 10.0, n_periods: 20, description: "10-min dt, 20 periods" },
    
    PropagationScenario { dt_minutes: 60.0, n_periods: 1, description: "1-hour dt, 1 period" },
    PropagationScenario { dt_minutes: 60.0, n_periods: 5, description: "1-hour dt, 5 periods" },
    PropagationScenario { dt_minutes: 60.0, n_periods: 10, description: "1-hour dt, 10 periods" },
    PropagationScenario { dt_minutes: 60.0, n_periods: 20, description: "1-hour dt, 20 periods" },
];
...
fn run_crossover_analysis(
    ...
    match gpu_result {
        ...
        Err(e) => {
            println!("{:4} {:>3} sats | {:25} | ERROR: {}", orbit_type, n_satellites, scenario.description, e);
        }
    }
}
